...
def filter_pairs_response(response_json: dict, coin: str, symbol: str, price_change: str, open_price: str,
                          exchange: str) -> list[dict]:
    response_json = [item for item in response_json if item[symbol][-len(coin):] == coin]
    response_json = [{
...
def get_binance_pairs(coin: str) -> list[dict]:
    ...
    return filter_pairs_response(response, coin, 'symbol', 'priceChange', 'openPrice', 'Binance')
...
def filter_pair_response(response_json: dict, bid_price: str, ask_price: str, high_price: str, low_price: str,
                         volume: str, exchange: str) -> dict:
    response_json = {
...
def get_binance_pair(symbol_1: str, symbol_2: str) -> dict:
    ...
    return filter_pair_response(response, 'bidPrice', 'askPrice', 'highPrice', 'lowPrice', 'volume',
                                'Binance')
